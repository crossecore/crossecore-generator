...
//		val containment = EcoreFactory.eINSTANCE.createEReference()
//		containment.name = "containment"
//		containment.EType = referencedType
//		containment.containment
//		eclass.EStructuralFeatures.add(containment)				
//		
